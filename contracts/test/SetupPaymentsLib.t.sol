...
import "../script/utils/TrendDataDeploymentLib.sol";
...
import {TrendDataTaskManagerSetup} from "test/TrendDataServiceManager.t.sol";
import {
    Quorum,
    StrategyParams,
    IStrategy
...
contract SetupPaymentsLibTest is Test, TestConstants, TrendDataTaskManagerSetup {
